"""Robust JSON parsing utilities for handling LLM outputs with various formatting issues."""
...
def safe_json_parse(json_string: str, fallback: Dict[str, Any] = None) -> Dict[str, Any]:
    """Robust JSON parser with multiple recovery strategies."""
    if fallback is None:
        fallback = {'list': [], 'count': 0}
